...
const CartScreen = ({ match, location, history }) => {
  ...
  const qty = location.search ? Number(location.search.split('=')[1]) : 1 ///console.log(location.search) = ?qty=1-- split('=')
  // [0] = ?qty, [1]=1
  ...
  const removeFromCarthanndler = (id) => {
                ...
                <Row>
                  ...
                  <Col md={2}>
                    <Button
                      type='button'
                      variant='light'
                      onClick={() => removeFromCarthanndler(item.product)}
                    >
